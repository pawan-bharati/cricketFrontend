...
export default class UserProfile extends Component {
    ...
    componentDidMount() {
        Axios.get('http://localhost:4000/register/me', this.state.config)
            .then((response) => {
                this.setState({
                    user: response.data
                })
    ...
    uploadFile = (e) => {
        ...
        Axios.post('http://localhost:4000/upload', data, this.state.config)
            .then((response) => {
                this.setState({
    ...
    updateUser = (e) => {
        e.preventDefault();
        Axios.put('http://localhost:4000/register/me', this.state.user, this.state.config)
